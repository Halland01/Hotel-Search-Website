<?php
	...
	{		
		...
		// check hotel name and city name.
		if($_SESSION["HotelName"] != "" && $_SESSION["City"] != ""){			
			$sql = "SELECT * FROM HotelInfo WHERE Hotel_Name = '{$_SESSION['HotelName']}' AND City = '{$_SESSION['City']}'";
			//var_dump($sql);
		}
		else if($_SESSION["HotelName"] == "" && $_SESSION["City"] != ""){
			$sql = "SELECT * FROM HotelInfo WHERE City = '{$_SESSION['City']}'";
		}
		else if($_SESSION["HotelName"] != "" && $_SESSION["City"] == ""){
			$sql = "SELECT * FROM HotelInfo WHERE Hotel_Name = '{$_SESSION['HotelName']}'";
		}
		else{
			$sql = "";
		}
  ...
  <body style='background-image: url("./img/background.jpg")'>
	...
	<div class="col-md-8">
		<table class="table table-hover table-inverse table-responsive">
			...
			<tr class="active">
				<td class="active"><?php echo $Hotel['HotelInfo_ID'];?></td>
				<td class="success"><?php echo $Hotel['Hotel_Name'];?></td>
				<td class="warning"><?php echo $Hotel['Hotel_Rating'];?></td>
				<td class="danger"><?php echo $Hotel['Country'];?></td>
				<td class="info"><?php echo $Hotel['City'];?></td>
				<td class="success"><?php echo $Hotel['free_room'];?></td>
			</tr>
			<?php endforeach;?>
		</table>
	</div>
